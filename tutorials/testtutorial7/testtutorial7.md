---
title: Set Up a CI/CD Pipeline for SAP BTP, Kyma Runtime 0
...
<ol type="a">
	...
	<li>Provide Client Secret: Password of communication user created in [Step 'Create a Communication User' of the previous tutorial](abap-environment-business-partner-basic-auth). Here you reuse the communication user in order to sign up to the OAuth 2.0 client.</li>
	<li>Choose **Create**</li>
</ol>
